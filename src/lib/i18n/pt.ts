const pt = {
  ...
  ifet: {
    ...
    tag: "IFET",
    intro:
      "Cada município recebe um score de 0 a 100: quanto voto está em jogo ali (peso) cruzado com o quanto {name} consegue tirar esse voto (alcance — histórico próprio, cidade-base, rede do partido, apoios). Alcance baixo derruba a prioridade por mais populoso que o município seja.",
    layerLabel: "Prioridade (0–100)",
    score: "Prioridade",
    layerIfet: "Prioridade",
    layerPeso: "Peso do território",
    layerAlcance: "Alcance do candidato",
    ...
    desempenhoHistorico: "Alcance do candidato",
    ...
    desempenhoHistoricoHint: "O quanto ESTE candidato consegue tirar voto aqui: histórico próprio, cidade-base, rede do partido e apoios. É o eixo que faltava.",
    quadrantsTitle: "Quadrantes estratégicos",
    quadExplain: {
      prioridade: "Muito voto em jogo E o candidato tem alcance aqui (base própria, rede ou apoios). É onde cada real de campanha rende mais voto — priorize agenda, mídia e estrutura.",
      expansao: "Muito voto, mas o candidato não tem pé aqui. Verba de mídia solta rende pouco. Só entra com padrinho local, tempo de TV ou palanque físico.",
      reduto: "Sua base. O voto aqui é seu para perder — invista em mobilização e comparecimento, não em convencimento.",
      fora: "Pouco voto ou fora do seu raio de influência. Presença institucional mínima; não invista recurso de campanha.",
    },
    contextoTitle: "Sem sinal territorial do candidato",
    contextoBody: "A plataforma ainda não tem histórico de campanha, município-base (domicílio eleitoral) nem apoios declarados desta candidatura. O mapa abaixo mostra só o PESO de cada município — quanto voto está em jogo —, não onde o candidato consegue tirar esse voto. Municípios sem dado de alcance aparecem vazados. Informe o domicílio eleitoral no perfil da candidatura para o índice calcular a prioridade real.",
    ancoraLabel: "Base do candidato",
    ancoraVia: { declarado: "informada", nascimento: "cidade natal", "ultima-campanha": "última campanha" },
    camadasTitle: "De onde vem o alcance",
    camadaPropria: "Campanha própria",
    camadaAncora: "Cidade-base e região imediata",
    camadaRede: "Rede de mandatos do partido",
    camadaApoios: "Apoios declarados",
    confiancaLabel: "Confiança do alcance",
    semAlcance: "sem sinal do candidato aqui",
    ranking: "Municípios por prioridade",
  ...
  movimento: {
    ...
    perda: "Perda",
    bolsoesCresc: "Bolsões de crescimento",
    bolsoesPerda: "Bolsões de perda",
    zonasFortes: "Zonas mais fortes",
    zonasFracas: "Zonas mais fracas",
    zonaCol: "Zona",
    swingCol: "Variação",
    shareCol: "Share",
    votosCol: "Votos",
    totalMovido: "Saldo total",
    selMun: "Município selecionado",
    interact: "Clique num município para ver a variação. Verde = cresceu; vermelho = perdeu.",
    vsAno: "vs.",
  },
  baseEditor: {
    ...
    baseLabel: "Cidade-base (domicílio eleitoral)",
    extrasLabel: "Outros municípios onde já atua",
    extrasHint: "separe por vírgula",
    save: "Salvar base",
    saved: "Base salva",
    current: "Base atual",
    none: "não informada — usando só o contexto do estado",
  },
  radar: {
  ...
  matriz: {
    ...
    sources: "Fontes",
    method:
      "Posição do município = média das posições dos partidos ponderada pelo voto. O eixo econômico leva um ajuste pequeno pelo PIB per capita (±0,06 — validado no backtest de 2º turno). O eixo de costumes leva um ajuste mínimo por escolaridade, urbanização e idade do eleitorado (achado clássico do comportamento político; não backtestável aqui). A escala de partido é calibrada pelo survey de especialistas de Bolognesi, Ribeiro & Codato (2022). É editável, não é um dado do TSE.",
  ...
  cenarios: {
    ...
    scatterTitle: "Dispersão: voto atual × prioridade",
    scatterX: "seu voto no município (share)",
    scatterY: "prioridade IFET",
    scatterAlvo: "município-alvo (maior lacuna × IFET)",
  ...
  partidos: {
    ...
    title: "Partidos",
    intro:
      "O mapa dos partidos em {uf}: quem disputa a mesma base de quem, e como cada um se posiciona no eixo ideológico. A partir da votação por município no {pleito}.",
    corrTitle: "Correlação de base",
    corrHint:
      "Quando um partido vai bem num município, o outro tende a ir bem (+) ou mal (−). Positivo = disputam a mesma base; negativo = bases opostas.",
    scatterTitle: "Posição ideológica",
    ecoLeft: "Estado / redistribuição",
    ecoRight: "Mercado / liberal",
    socTop: "Conservador em costumes",
    socBottom: "Liberal em costumes",
    tableTitle: "Os partidos",
    colParty: "Partido",
    colVotos: "Votos",
    colShare: "Share",
    colBench: "Bancada",
    colAfim: "Base mais parecida",
    colOposto: "Base mais oposta",
    needCandidate: "Selecione um candidato no onboarding para carregar o estado.",
    empty: "Não foi possível carregar a votação por partido para este estado agora.",
    disclaimer: "Análise de apoio interno a partir de dados oficiais.",
    fichaTitle: "Ficha técnica",
    version: "Versão",
    sources: "Fontes",
  },
  concorrentes: {
    navLabel: "Concorrentes",
    title: "Concorrentes",
    intro:
      "Adicione 2 ou mais candidatos. A NeoVoto cruza a votação real por município, a ideologia do partido e a atividade legislativa de cada um.",
    yourCandidate: "Seu candidato",
    addTitle: "Adicionar concorrente",
    placeholder: "Nome do candidato ou parlamentar…",
    allOffices: "Buscar em todos os cargos (espelho do TSE)",
    empty: "Nada encontrado.",
    add: "Adicionar",
    full: "Arena cheia (máx. 4). Remova um para adicionar outro.",
    remove: "remover",
    clear: "Limpar arena",
    needMore: "Adicione pelo menos um concorrente para comparar.",
    radarTitle: "Perfil comparado",
    radarNote: "Comparação relativa entre os selecionados (0–100, mín–máx na arena).",
    scatterTitle: "Ideologia × votos",
    scatterX: "eixo ideológico",
    scatterY: "votos (log)",
    scatterLeft: "Estado / redistribuição",
    scatterRight: "Mercado / liberal",
    tableTitle: "Os números",
    colCand: "Candidato",
    colVotos: "Votos",
    colMunicipios: "Municípios",
    colConc: "Conc. top 5",
    colPen: "Voto / hab.",
    colProp: "Proposições",
    colEixo: "Eixo eco / cost.",
    eixoVotos: "Votos",
    eixoAlcance: "Alcance",
    eixoConcentracao: "Concentr.",
    eixoPenetracao: "Penetr.",
    eixoLegislativo: "Legislativo",
    noVote: "sem votação",
    disclaimer:
  ...
  onboarding: {
    ...
    allOfficesEmpty: "Nenhum candidato com esse nome nas eleições registradas.",
    selected: "Selecionado",
    change: "trocar",
    cargoTitle: "Para qual cargo em 2026?",
    cargoSub: "A NeoVoto analisa a disputa DESTE cargo — não o que o candidato foi antes.",
    apoiosTitle: "Apoios de políticos eleitos",
    apoiosSub: "Opcional, mas muda a análise. Vereadores, prefeitos, deputados que estão ativamente na campanha. A NeoVoto projeta a sua base como uma fração transferível da base deles nos redutos deles — não como o voto do partido inteiro.",
    apoiosPlaceholder: "Nome de um apoiador eleito…",
    apoiosNone: "Sem apoios declarados. Para candidato sem histórico, a análise fica só de território e temas.",
    apoioAdd: "adicionar",
    manualCta: "Meu candidato não está na lista",
    manualTitle: "Cadastrar candidato",
    manualSub: "Para primeira campanha ou candidato sem histórico. A análise parte do território, do partido e dos temas.",
    manualNome: "Nome do candidato",
    manualPartido: "Partido (sigla)",
    manualUf: "Estado (UF)",
    manualBase: "Cidade-base (domicílio eleitoral)",
    manualBaseHint: "Onde o candidato vota e atua. A plataforma usa isso e a região imediata do IBGE para calcular o raio de influência real — sem isso, só sobra o contexto do estado.",
    manualNext: "Continuar",
    manualBack: "voltar à busca",
